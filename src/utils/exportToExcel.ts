...
export async function exportEmployeesToExcel(employees: CalculatedEmployee[], branchName: string) {
  ...
  worksheet.columns = [
    { width: 6 },  // 1. م
    { width: 14 }, // 2. كود الموظف
    { width: 30 }, // 3. اسم الموظف
    { width: 24 }, // 4. الوظيفة
    { width: 18 }, // 5. جهة العمل
    { width: 15 }, // 6. تاريخ التعيين
    { width: 18 }, // 7. تاريخ العودة من اخر اجازة
    { width: 15 }, // 8. تاريخ الاحتساب
    { width: 15 }, // 9. مدة العمل الاجمالية
    { width: 16 }, // 10. مدة العمل من اخر اجازة
    { width: 16 }, // 11. الراتب الأساسي
    { width: 16 }, // 12. البدلات الثابتة
    { width: 18 }, // 13. اجمالي الراتب
    { width: 14 }, // 14. سعر التذكرة
    { width: 16 }, // 15. مخصص التذاكر
    { width: 16 }, // 16. مخصص الاجازة
    { width: 18 }, // 17. مخصص نهاية الخدمة
    { width: 18 }, // 18. مسحوبات نهاية الخدمة
    { width: 20 }, // 19. المستحق من نهاية الخدمة
  ];
  ...
  const headers = [
    ...
    'جهة العمل',
    'تاريخ التعيين',
    'تاريخ العودة من اخر اجازة',
    'تاريخ الاحتساب',
    'مدة العمل الاجمالية',
    'مدة العمل من اخر اجازة',
    'الراتب الأساسي',
    'البدلات الثابتة',
    'اجمالي الراتب',
    'سعر التذكرة',
    ...
    'مخصص الاجازة',
    'مخصص نهاية الخدمة',
    'مسحوبات نهاية الخدمة',
    'المستحق من نهاية الخدمة'
  ];
