      ...
      <div className={`${theme.wrapper} mx-auto w-full max-w-full flex-grow flex flex-col text-black text-xs sm:text-sm font-sans overflow-x-auto print-single-page h-full`} dir="rtl">
        ...
        <table className="w-full border-collapse border-2 border-black text-center mb-2 font-bold text-[10px] sm:text-xs print:text-[10px]">
          <tbody>
            ...
            <tr>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 bg-gray-50 w-[22%] whitespace-nowrap">مدة العمل منذ اخر اجازة</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 font-mono w-[28%] whitespace-nowrap">{formatNumber(emp.durationSinceLastVacationYears)} سنه</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 bg-gray-50 w-[22%] whitespace-nowrap">تاريخ الطلب</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 font-mono text-blue-600 w-[28%] whitespace-nowrap">
                {renderRequestDate()}
              </td>
            </tr>
          </tbody>
        ...
        <table className="w-full border-collapse border-2 border-black text-center mb-2 font-bold text-[10px] sm:text-xs print:text-[10px]">
          <tbody>
            <tr className={theme.tableHeadClass}>
              <td className="border border-black p-1 sm:p-1.5 print:p-1" colSpan={4}>نوع الاجازة المطلوبة</td>
            </tr>
             <tr>
              <td className="border border-black p-1 sm:p-1.5 print:p-1">
            ...
            <tr>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 bg-gray-50 whitespace-nowrap">تاريخ بداية الاجازة</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 font-mono text-blue-600 font-bold whitespace-nowrap">
                {renderStartDate()}
              </td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 bg-gray-50 whitespace-nowrap">العودة من آخر إجازة</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 font-mono text-blue-600 font-bold whitespace-nowrap">
                {renderReturnDate()}
              </td>
            </tr>
            <tr>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 bg-gray-50 whitespace-nowrap">مدة الاجازة المطلوبة</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 font-mono text-blue-600 font-bold whitespace-nowrap">{requestedLeaveDays || 0} يوم</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 bg-gray-50 whitespace-nowrap">رصيد الاجازة المستحق قبل الطلب</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 font-mono whitespace-nowrap">{formatNumber(balanceBefore)} يوم</td>
            </tr>
            <tr>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 bg-gray-50 whitespace-nowrap">الرصيد المتبقي بعد الطلب</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 font-mono text-emerald-700 font-bold whitespace-nowrap" colSpan={3}>{formatNumber(balanceAfter)} يوم</td>
            </tr>
          </tbody>
        </table>
        ...
        <table className="w-full border-collapse border-2 border-black text-right mb-2 font-bold text-[10px] sm:text-xs print:text-[10px] bg-white">
          <tbody>
            <tr className="h-12 print:h-12">
              <td className="border border-black p-1 bg-white text-right w-[33%] align-top pt-1.5 pr-2">
                توقيع الموظف :
              </td>
              <td className="border border-black p-1 bg-white text-right w-[33%] align-top pt-1.5 pr-2">
                Signature :
              </td>
              <td className="border border-black p-1 bg-white text-right w-[34%] align-top pt-1.5 pr-2">
                اسم الموظف البديل :
              </td>
            </tr>
            <tr className="h-12 print:h-12">
              <td className="border border-black p-1 bg-white text-right w-[66%] align-top pt-1.5 pr-2" colSpan={2}>
                توقيع الموظف البديل :
              </td>
              <td className="border border-black p-1 bg-white text-right w-[34%] align-top pt-1.5 pr-2">
                رقم الاتصال :
            ...
            <tr className="h-12 print:h-12">
              <td className="border border-black p-1 bg-white text-right align-top pt-1.5 pr-2" colSpan={3}>
                الملاحظات :
              </td>
            </tr>
          </tbody>
          ...
          <div className="mb-1 print:mb-0.5">
            ...
            <div className="grid grid-cols-2 gap-3 print:gap-2 text-center text-xs print:text-[10px]">
              {displayMonths.slice(0, 4).map((m, idx) => (
                <div key={idx} className="border border-black p-2 sm:p-3 print:p-2 rounded bg-gray-50/50 flex flex-col justify-between">
                  <div className="font-bold border-b border-gray-400 pb-1 mb-1.5 print:mb-1 print:pb-0.5 text-center text-xs sm:text-sm print:text-xs">{m.title}</div>
        ...
        <div className="flex justify-between items-end mt-auto pt-1 print:mt-auto pb-1 print:pb-1.5 px-4 font-bold text-xs print:text-[11px] gap-2">
