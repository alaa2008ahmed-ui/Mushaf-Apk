      ...
      <div className={`${theme.wrapper} mx-auto w-full max-w-full flex-grow flex flex-col text-black text-xs sm:text-sm font-sans overflow-x-auto print-single-page h-full`} dir="rtl">
        ...
        <table className="w-full border-collapse border-2 border-black text-center mb-2 print:mb-1 font-bold text-[10px] sm:text-xs print:text-[10px]">
          <tbody>
            ...
            <tr>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 bg-gray-50 w-[22%] whitespace-nowrap">المهنة</td>
              ...
              <td className="border border-black p-1 sm:p-1.5 print:p-1 bg-gray-50 w-[22%] whitespace-nowrap">تاريخ الطلب</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 font-mono w-[28%] whitespace-nowrap">{formatDateGB(new Date())}</td>
            </tr>
            <tr>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 bg-gray-50 w-[22%] whitespace-nowrap">تاريخ بداية الاجازة</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 font-mono text-center text-blue-600 w-[28%] whitespace-nowrap">
                {renderStartDateInput()}
              </td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 bg-gray-50 w-[22%] whitespace-nowrap">تاريخ العودة من الاجازة</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 font-mono text-center text-blue-600 w-[28%] whitespace-nowrap">
            ...
            <tr>
              ...
              <td className="border border-black p-1 sm:p-1.5 print:p-1 font-mono w-[28%] whitespace-nowrap">{formatDateGB(emp.lastVacationReturnDate || emp.hireDate)}</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 bg-gray-50 w-[22%] whitespace-nowrap">آخر يوم عمل</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 font-mono w-[28%] whitespace-nowrap">{formatDateGB((emp as any).lastWorkDate || emp.calculationDate)}</td>
            </tr>
            <tr>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 bg-gray-50 w-[22%] whitespace-nowrap">سبب الاجازة</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 w-[28%] whitespace-nowrap">
            ...
            <tr>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 bg-gray-50 w-[22%] whitespace-nowrap">رصيد الاجازات المستحقة</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 w-[28%] whitespace-nowrap">
              ...
              <td className="border border-black p-1 sm:p-1.5 print:p-1 bg-gray-50 w-[22%] whitespace-nowrap">ملاحظات</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 w-[28%] whitespace-nowrap"></td>
            </tr>
          </tbody>
        </table>
        ...
        <table className="w-full border-collapse border-2 border-black text-center mb-2 print:mb-1 font-bold text-[10px] sm:text-xs print:text-[10px]">
          <tbody>
            <tr>
              <td className="border border-black p-1 bg-gray-50 w-1/4 whitespace-nowrap">تاريخ دخول المملكه من مقيم</td>
              <td className="border border-black p-1 w-1/4 whitespace-nowrap"></td>
              <td className="border border-black p-1 bg-gray-50 w-1/4 whitespace-nowrap">اعتماد شئون الموظفين</td>
              <td className="border border-black p-1 w-1/4 whitespace-nowrap"></td>
            </tr>
          </tbody>
        </table>
          ...
          <tbody>
            <tr>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 whitespace-nowrap">
                راتب ايام العمل {isProportionalActive && <span className="text-[10px] font-normal">({workDaysCount} يوم)</span>}
              </td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 text-left px-2 whitespace-nowrap" dir="ltr">Salary Of Working</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1">{formatNumber(workDaysSalary)}</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 whitespace-nowrap">الراتب الاساسي</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1">{formatNumber(emp.basicSalary)}</td>
            </tr>
            <tr>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 whitespace-nowrap">
                بدل العمل الإضافي {isProportionalActive && <span className="text-[10px] font-normal">({overtimeHours} ساعة)</span>}
              </td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 text-left px-2 whitespace-nowrap" dir="ltr">Extra Work</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1">{formatNumber(overtimeValue)}</td>
            ...
            <tr>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 whitespace-nowrap">
                بدل السكن {isProportionalActive && <span className="text-[10px] font-normal">({workDaysCount} يوم)</span>}
              </td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 text-left px-2 whitespace-nowrap" dir="ltr">Housing Allowance</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1">{formatNumber(housingValue)}</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 whitespace-nowrap">بدل السكن</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1">{formatNumber(emp.housingAllowance || 0)}</td>
            </tr>
            <tr>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 whitespace-nowrap">
                بدل انتقال {isProportionalActive && <span className="text-[10px] font-normal">({workDaysCount} يوم)</span>}
              </td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 text-left px-2 whitespace-nowrap" dir="ltr">Transfer Allowance</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1">{formatNumber(transferValue)}</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 whitespace-nowrap">بدل انتقال</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1">{formatNumber(emp.transferAllowance || 0)}</td>
            </tr>
            <tr>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 whitespace-nowrap">
                بدلات اخري {isProportionalActive && <span className="text-[10px] font-normal">({workDaysCount} يوم)</span>}
              </td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 text-left px-2 whitespace-nowrap" dir="ltr">Other Allowances</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1">{formatNumber(otherAllowancesValue)}</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 whitespace-nowrap">بدلات اخرى</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1">{formatNumber((emp.fixedAllowances || 0) - (emp.housingAllowance || 0) - (emp.transferAllowance || 0))}</td>
            </tr>
            <tr>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 whitespace-nowrap">بدل الاجازه</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 text-left px-2 whitespace-nowrap" dir="ltr">Vacation Allowance</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1">{formatNumber(emp.vacationAllowance)}</td>
            ...
            <tr className="bg-gray-200">
              ...
              <td className="border border-black p-1 sm:p-1.5 print:p-1 font-mono">{formatNumber(totalAllowancesGross)}</td>
        ...
        <table className="w-full border-collapse border-2 border-black text-center mb-2 print:mb-1 font-bold text-[10px] sm:text-xs print:text-[10px]">
          <thead>
            <tr className={theme.tableHeadClass}>
              ...
              <th className="border border-black p-1 sm:p-1.5 print:p-1 w-[15%]">المبلغ</th>
              <th className="border border-black p-1 sm:p-1.5 print:p-1 w-[60%]">بيان وتفاصيل الخصم</th>
            </tr>
          </thead>
          <tbody>
            {emp.includeSocialSecurity !== false && (
              <tr>
                <td className="border border-black p-1 sm:p-1.5 print:p-1 text-right px-2 whitespace-nowrap">تامينات اجتماعية</td>
                <td className="border border-black p-1 sm:p-1.5 print:p-1 font-mono text-red-600">{formatNumber(socialSecurityDeduction)}</td>
                <td className="border border-black p-1 sm:p-1.5 print:p-1"></td>
              </tr>
            )}
            <tr>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 text-right px-2 whitespace-nowrap">سلفيات</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 font-mono text-red-600">{formatNumber(emp.loans || 0)}</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1"></td>
            </tr>
            <tr>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 text-right px-2 whitespace-nowrap">خصم إجازة</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 font-mono text-red-600">{formatNumber(absenceDeduction)}</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1"></td>
            </tr>
            <tr className="bg-gray-200">
              <td className="border border-black p-1 sm:p-1.5 print:p-1 text-right px-2 whitespace-nowrap">مجموع الحسميات</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1 font-mono text-red-800">{formatNumber(totalDeductions)}</td>
              <td className="border border-black p-1 sm:p-1.5 print:p-1"></td>
            </tr>
          </tbody>
        </table>
